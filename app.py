...
st.markdown("<h1 style='text-align: center; color: red;'>💻 Code With Irsa</h1>",unsafe_allow_html=True)
st.markdown(
    "<h1 style='text-align: center; font-size: 2.5rem;color:red'>⌕ File Converter & Cleaner ⌕</h1>",
